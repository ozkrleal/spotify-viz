...
spotify_songs[nchar(playlist_name)>80][,.N, by = playlist_name][order((-N))]
spotify_songs[nchar(playlist_name)>50][,.N, by = playlist_name][order((-N))]
...
```{r}
ggRadar(data = plotdf, aes(group = year), size = 3, ylim = 1.02) +
